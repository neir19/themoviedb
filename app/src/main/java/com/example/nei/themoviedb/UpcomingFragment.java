...
public class UpcomingFragment extends Fragment {
    ...
    private Button bbacku, bnextu;
    private TextView tpageu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerU(ApiKey,page);
        bbacku=view.findViewById(R.id.bbackU);
        bbacku.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tpageu=view.findViewById(R.id.tpageU);
        bnextu=view.findViewById(R.id.bnxtU);
        bnextu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                page=page+1;
                recyclerU(ApiKey,page);
    ...
    private void recyclerU(String apiKey, int page) {
